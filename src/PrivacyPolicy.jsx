  ...
  return (
    <div className="terms">
      <SEOMetaTag
        ...
        url="https://gtdgolfkorea.web.app/policy"
      />
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          <Box textAlign={"left"}>
            <ul>
              <li>
                (주)GTD는 (이하 "회사"는) 고객님의 개인정보를 중요시하며,
                "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고
                있습니다. 회사는 개인정보처리방침을 통하여 고객님께서 제공하시는
              ...
              <li>
                ...
                <p>
                  가. 수집하는 개인정보의 항목 o 회사는 회원가입, 상담, 서비스
                  신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                </p>
                <p>
                ...
                <p>
                  - 서비스 신청시 : 주소, 결제 정보 o 서비스 이용 과정이나 사업
                  처리 과정에서 서비스이용기록, 접속로그, 쿠키, 접속 IP, 결제
                  기록, 불량이용 기록이 생성되어 수집될 수 있습니다.
                </p>
                <p>
                  나. 수집방법 - 홈페이지, 서면양식, 게시판, 이메일, 이벤트
                  응모, 배송요청, 전화, 팩스, 생성 정보 수집 툴을 통한 수집
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>o 위탁 대상자 : [택배사 이름]</p>
                <p>o 위탁업무 내용 : [택배사 위탁 내용]</p>
                <p>o 위탁 대상자 : [PG사 이름]</p>
                <p>o 위탁업무 내용 : [PG사 위탁 내용]</p>
                <p>o 위탁 대상자 : 공급업체 목록보기</p>
                <p>o 위탁업무 내용 : [위탁업무 내용]</p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  ...
                  등을 운용합니다. 쿠키란 웹사이트를 운영하는데 이용되는 서버가
              ...
              <li>
                ...
                <p>성명 : 이예담</p>
                <p>소속 : 웹</p>
                <p>전화번호 : 010-3O39-2264</p>
                <p>이메일 : dldpeka0909@miurakorea.com</p>
                <p>o 개인정보보호책임자</p>
                <p>성명 : 이예담</p>
                <p>소속 : 웹</p>
                <p>전화번호 : 010-3O39-2264</p>
